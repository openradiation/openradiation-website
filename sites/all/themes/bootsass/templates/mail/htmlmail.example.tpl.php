...
<table border="0" CELLPADDING="0" CELLSPACING="0" style="width:100%; background-color: #EEE;">
  <tr>
    <td style="width:15px;"></td>
    <td><img src="<?php print $theme_url . '/images/ariane_logo_small.png' ?>" alt="Ariane" height="27" width="85" style="margin-bottom: 15px; margin-top: 20px;"></td>
    <td style="width:15px;"></td>
  </tr>
  <tr>
    <td></td>
