...
<body<?php print $body_attributes; ?>>
  ...
  if (drupal_is_front_page()) {
    ...
    <script>
      ...
      function sizeOpenRadiationMap() {
        if(jQuery( window ).width() > 770) {
          var height = jQuery("aside.col-sm-4").height();
          jQuery("#openradiation-map-iframe").height(height);
        } else {
          jQuery("#openradiation-map-iframe").height(350);
        }
