...
<div id="node-<?php print $node->nid; ?>" class="dashboard resource">
    <div class="media">
        <?php  if ( isset( $node->field_resource_image['und'][0] ) == true ) {  ?>
        <div class="media-left">
            <a href="<?php print $node_url ?>" title="<?php print $title ?>">
                <span class="picture-field"><?php print render($content['field_resource_image']) ?></span>
            </a>
        </div>
        <?php } ?>
      ...
      <div class="media-body">
        ...
        <?php if ( isset( $content['field_resource_files'] ) == true ) {  ?>
          <?php print render($content['field_resource_files']) ?>
        <?php } ?>
        <?php if ( isset( $content['field_resource_url'] ) == true ) {  ?>
