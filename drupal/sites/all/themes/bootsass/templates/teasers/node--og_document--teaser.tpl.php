...
$file = $node->field_document_file['und'][0];
...
<div id="node-<?php print $node->nid; ?>" class="node-teaser <?php print $classes; ?> clearfix media"<?php print $attributes; ?>>
  <span class="icon-file-<?php print $icotype[$file_extension] ?> icon-gray"></span>
  ...
  <?php print render($title_prefix); ?>
    <span<?php print $title_attributes; ?>>
		...
		<?php if (isset($comment_count) && $comment_count): ?>
			<span class="badge" data-toggle="tooltip" data-placement="top" title="<?php print format_plural($comment_count, 'Il y a un commentaire sur ce document', 'Il y a @count commentaires sur ce document') ?>"><?php print $comment_count ?></span> 
		<?php endif; ?>
		<?php $new_comments = comment_num_new($node->nid); ?>
		<?php if ($new_comments): ?>
			<span class="badge badge-success" data-toggle="tooltip" data-placement="top" title="<?php print format_plural($new_comments, 'Il y a un nouveau commentaire sur ce document', 'Il y a @count nouveaux commentaires sur ce document') ?>"><?php print $new_comments ?></span>
		<?php endif; ?>
	</span>
